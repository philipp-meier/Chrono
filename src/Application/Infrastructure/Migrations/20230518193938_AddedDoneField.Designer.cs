...
namespace Chrono.Infrastructure.Migrations
{
    ...
    [Migration("20230518193938_AddedDoneField")]
    partial class AddedDoneField
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryTask", b =>
                {
                    b.HasOne("Chrono.Domain.Entities.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Chrono.Domain.Entities.Task", null)
                        .WithMany()
