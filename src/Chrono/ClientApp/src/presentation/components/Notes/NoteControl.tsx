...
import {createNote, deleteNote, getNote, updateNote} from "../../../infrastructure/services/NoteService.ts";
import {Note} from "../../../domain/models/Note.ts";

enum NoteControlMode {
  Add,
  Edit,
}

const NoteControl = (props: {
  mode: NoteControlMode;
  id?: number;
}) => {
  ...
  useEffect(() => {
    const dataFetch = async () => {
      if (props.mode === NoteControlMode.Edit && props.id) {
  ...
  if (props.mode === NoteControlMode.Edit && (!props.id || props.id < 0))
      ...
      <Form style={{marginTop: "1em"}} onSubmit={saveNote}>
        ...
        <Form.Field>
          <Button.Group primary>
            ...
            {props.mode !== NoteControlMode.Add && (
              <Dropdown
...
export {NoteControl, NoteControlMode};
